...
- Return 0 to 5 facts. Return an empty list if there is nothing durable.

Respond with JSON only: {"facts": ["...", "..."]}`;

export async function extractFacts(userName: string, userMessage: string, assistantReply: string): Promise<string[]> {
